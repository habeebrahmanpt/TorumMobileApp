    ...
    return (
        <View style={style.container}>
            <View style={style.signInTextView}>
                <Image style={style.signInImage} source={appImages.appLogo} />
            </View>
            <View style={style.signInTextView}>
            ...
            <TouchableOpacity style={style.skipButton} onPress={navigateToHome}>
                <Text style={[style.buttonText, { color: Colors.appTheme }]}>
                    {LocalizedLabel.skipLogin}
                </Text>
            </TouchableOpacity>
        </View>
    );
